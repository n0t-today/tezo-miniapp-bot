...
ТЗ распределены по логическим директориям проекта:

| Документ | Расположение | Описание |
|----------|--------------|----------|
| Общее ТЗ | `docs/TZ.md` | Этот документ |
| Оглавление ТЗ | `docs/README_TZ.md` | Комплект документов и порядок изучения |
| ТЗ бэкенда | `backend/docs/TZ_Backend.md` | API, интеграции, логирование |
| Схема БД | `backend/docs/DB_Schema.md` | PostgreSQL: таблицы, связи |
| ТЗ фронтенда | `frontend/docs/TZ_Frontend.md` | Стек, маршруты, компоненты (общее) |
| ТЗ Mini App | `frontend/miniapp/docs/TZ_Mini_App.md` | Страницы мини-приложения |
| ТЗ Web Admin | `frontend/admin/docs/TZ_Web_Admin.md` | Страницы веб-админки |
